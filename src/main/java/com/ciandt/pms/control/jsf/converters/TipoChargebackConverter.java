...
/**
 * A classe TipoChargebackConverter é um conversor para os valores
 ...
 * 
 */
public class TipoChargebackConverter implements Converter {
    ...
    public Object getAsObject(final FacesContext context,
        ...
        if (value != null) {
            ...
            String manualValue = BundleUtil
                    .getBundle(Constants.BUNDLE_KEY_CHARGEBACK_TYPE_MANUAL);
            String syncValue = BundleUtil
                    .getBundle(Constants.BUNDLE_KEY_CHARGEBACK_TYPE_SYNC);
