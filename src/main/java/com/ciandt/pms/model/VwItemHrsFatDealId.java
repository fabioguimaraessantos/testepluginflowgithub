...
/**
 * VwItemHrsFatDealId generated by hbm2java.
 * 
 ...
 */
@Embeddable
public class VwItemHrsFatDealId implements java.io.Serializable {
    ...
    /**
     * Constante para NamedQuery "VwItemHrsFatDealId.findAll".
     */
    public static final String FIND_ALL = "VwItemHrsFatDealId.findAll";
     ...
     */
    public VwItemHrsFatDealId(final Long codigoPessoa,
    ...
    public boolean equals(final Object other) {
        ...
        if (!(other instanceof VwItemHrsFatDealId)) {
            return false;
        }
        VwItemHrsFatDealId castOther = (VwItemHrsFatDealId) other;
