    ...
    IF (v_reli_in_status IS NULL OR v_reli_in_status = 'W') THEN
      ...
      IF (v_nr_cgc IS NOT NULL) THEN
        ...
        IF (v_erp_cd_ccusto IS NOT NULL
          ...
          AND i.fore_cd_fonte_receita  = con_fonte_receita --con_fonte_receita = 4 (constante)
          ...
          SET r.RELI_IN_STATUS = 'I', r.RELI_IN_VERSAO = 'IN', r.reli_cd_erp_pedido = v_ped_in_sequencia
