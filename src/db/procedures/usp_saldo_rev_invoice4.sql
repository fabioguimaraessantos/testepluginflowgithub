create or replace procedure usp_saldo_rev_invoice4 is
   ...
   cursor cursor_receita is
           select rdf.defi_cd_deal_fiscal     cd_deal_fiscal,
                ...
                from   receita_deal_fiscal rdf,
                       receita             rec,
                       deal_fiscal         df,
                      (select  aj.redf_cd_receita_dfiscal , sum(aj.ajre_vl_ajuste) vl_ajuste_total from  pms.ajuste_receita aj group by aj.redf_cd_receita_dfiscal ) ajuste
                where  rdf.defi_cd_deal_fiscal = df.defi_cd_deal_fiscal
                       and rdf.rece_cd_receita = rec.rece_cd_receita
                       and ajuste.redf_cd_receita_dfiscal (+) = rdf.redf_cd_receita_dfiscal
                      --and rdf.defi_cd_deal_fiscal in (3747) --=====> PARA TESTE
       ...
       --     exit;
        --end if;
            ...
            if (fiscal_deal =  0) then
                ...
                execute immediate 'TRUNCATE TABLE fatura_receita2';                                               
                           ...
                           cursor cursor_invoice is
                                        ...
                                        from   fatura fat,
                                         ...
                                         where  fat.fatu_cd_fatura = ifat.fatu_cd_fatura
                                                    ...
                                                    --and  fat.fatu_cd_fatura in (349,346,338) -- TESTE APENAS
